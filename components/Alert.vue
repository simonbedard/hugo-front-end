...
export type IStyles = 'primary' | 'success' | 'warning' | 'danger' | 'infos'
...
const styles = reactive<{
  ...
  infos:
    'dark:from-pink-500/50 via-gray-200 to-gray-200 dark:via-slate-800 dark:to-slate-800',
  danger:
...
const selectedType = computed<IStyles>((): IStyles => {
  if (['primary', 'success', 'warning', 'danger', 'infos'].includes(props.type))
    ...
    >
      ...
      >
        ...
        <div class="flex-1">
          ...
          <div class="text-gray-700 dark:text-gray-100 text-sm">

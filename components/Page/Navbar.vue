...
<template>
  <BuilderNavbar>
    ...
    <template #menu>
      <div class="relative hidden lg:flex items-center ml-auto w-full">
        <nav
          class="text-sm leading-6 font-semibold text-gray-600 dark:text-gray-300 flex-1 ml-4"
          role="navigation"
        >
         <PageSearchForm ref="SearchForm"/>
          <!-- // STARTER KIT MENU REPLACE BY SEARCH BAR, 
        ...
        >
          ...
          <Anchor
            ...
            href="https://github.com/simonbedard"
            title="Github"
          >
            <IconMdi:github-face />
          </Anchor>
